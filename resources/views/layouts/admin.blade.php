...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        ...
        <span class="sys-title">琅琊阁后台管理系统</span>
        <ul class="ht-nav">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="leftnav">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" data-url="{{ url('admin/datalist') }}" data-id="2">资源管理</a></dd>
                        <dd><a href="javascript:;" data-url="{{ url('admin/datalist') }}" data-id="3">时光轴管理</a></dd>
                        <dd><a href="javascript:;">笔记本管理</a></dd>
                        <dd><a href="javascript:;" data-url="{{ url('admin/datalist') }}" data-id="4">文章回收站</a></dd>
